...
#  Default: []
c.InteractiveShellApp.exec_lines = ['%load_ext jupyter_ai_magics', '%load_ext magic_pandas_ai', '%config AiMagics.default_language_model = "my_provider:deepseek-r1:7b"']
