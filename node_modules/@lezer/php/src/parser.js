...
import {expression, interpolated, semicolon, eofToken, keywords} from "./tokens"
import {phpHighlighting} from "./highlight"
...
export const parser = LRParser.deserialize({
  ...
  specialized: [{term: 81, get: (value, stack) => (keywords(value, stack) << 1), external: keywords},{term: 81, get: (value) => spec_Name[value] || -1}],
  tokenPrec: 29378
})
